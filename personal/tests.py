...
class GalleryTestClass(TestCase):
    def setUp(self):
        ...
        self.new_image = Image(id=1,image_name='learn', image_description='Learn 2021',image_path='media/gallery/dance-3134828_1920.jpg',image_category=self.new_category,image_location=self.new_location)
